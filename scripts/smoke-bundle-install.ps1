...
try {
    ...
    if (
        ...
        $releaseKitSmoke.client_config_probe_tamper_blocked -ne $true -or
        $releaseKitSmoke.licensed_preflight_tamper_blocked -ne $true -or
    ...
    [ordered]@{
        ...
        release_kit_client_config_probe_tamper_blocked = $releaseKitSmoke.client_config_probe_tamper_blocked
        release_kit_licensed_preflight_tamper_blocked = $releaseKitSmoke.licensed_preflight_tamper_blocked
