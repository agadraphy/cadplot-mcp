...
| Install and remove a release safely | matching-SDK bundle builder, complete release builder, transactional install/verifiers/uninstallers | synthetic bundle/release/install/uninstall smokes and exact hash-tree verification | Installer path verified synthetically; real matching-SDK bundle and company-machine install remain external |
