...
| Prove PDFs belong to the successful run and are not blank pages | schema-v2 manifest-and-output-bound receipt plus structural/physical/marking-content PDF audit | fixed Python/.NET digest vector, valid-PDF replacement tamper test, blank/no-paint rejection, 300/300 marking-content rehearsal, restart recovery test | Implemented and locally verified; semantic crop/scale/style acceptance and live receipts/PDFs remain external evidence |
